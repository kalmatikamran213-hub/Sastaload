...
const Stats: React.FC = () => {
    return (
        <section className="bg-slate-900 py-6 lg:py-8 border-y border-slate-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8 text-center">
                    {stats.map((stat, idx) => (
                        <div key={idx} className="space-y-0.5 lg:space-y-1 reveal-on-scroll" style={{ transitionDelay: `${idx * 100}ms` }}>
