...
import { MapPin, Box, Scale, Calendar, Loader2, AlertCircle, Info, Fuel, TrendingUp, Target, ThumbsUp, ThumbsDown, CheckCircle, AlertTriangle, ThermometerSnowflake, Layers, ShieldCheck, AlertTriangle as AlertIcon, BarChart3, Briefcase, Droplet } from 'lucide-react';
      ...
      <div className="relative z-10">
        ...
        <form onSubmit={handleEstimate} className="space-y-4">
          ...
          <div className="relative group">
            ...
            <input 
              type="text" 
              placeholder="Pickup City (e.g. Karachi)" 
          ...
          <div className="relative group">
            ...
            <input 
              type="text" 
              placeholder="Dropoff City (e.g. Lahore)" 
            ...
            <div className="relative group">
               ...
               <select 
                ...
                >
                  ...
                  <option value="Fragile Items">Fragile</option>
                  <option value="Heavy Mach.">Heavy Mach.</option>
                  <option value="HazMat">HazMat</option>
                  <option value="Bulk Raw">Bulk Raw</option>
